...
- [Getting Started](./getting-started.md)
  - [Configuration Files](./getting-started/configuration-files.md)
  - [Schema](./getting-started/schema.md)
  - [Configuring a stream](./getting-started/configuring-streams.md)
  - [Writing to a stream](./getting-started/writing-streams.md)
  - [Reading from a stream](./getting-started/reading-streams.md)
  - [Stream Mapping](./getting-started/stream-mapping.md)
